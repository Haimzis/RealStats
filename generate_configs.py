...
patch_divisors_choices = ["0 1", "0 1", "0 1", "0", "0"]
chi2_bins_choices = [10, 15, 20, 25, 30, 40]
N = 200
...
def generate_configurations(num_configs=N):
    ...
    for _ in range(num_configs):
        ...
        waves = random.sample(waves_choices, random.randint(4, 10)) + ['blurness', 'gabor', 'hsv', 'jpeg', 'laplacian', 'sift', 'ssim']
