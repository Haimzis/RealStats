...
# Redirect all output (stdout + stderr) to logs.txt
{
    ...
    python executor_inference.py \
        ...
        --gpu "0,1,2,3" \
        --independent_keys \
            PatchProcessing_wavelet=RIGID.DINO.05_level=0_patch_size=512_seed=87467 \
            PatchProcessing_wavelet=RIGID.RESNET.100_level=0_patch_size=512_seed=87467 \
        --patch_divisors 0 \
        --chi2_bins 10 \
        --cdf_bins 400 \
        ...
        --run_id plot_gaugan_run_$TIMESTAMP
